            ...
            <div class="chooseArea">
              ...
              >
                ...
                <dd
                  ...
                  @click="setActive(saleAttr.spuSaleAttrValueList, index)"
                >
...
export default {
  ...
  methods: {
    setActive(spuSaleAttrValueList, index) {
      spuSaleAttrValueList.forEach((item) => {
        item.isChecked = "0";
      });
      spuSaleAttrValueList[index].isChecked = "1";
      const test = this.spuSaleAttrList[0].spuSaleAttrValueList.filter(
        (t) => t.isChecked == 1
      );
    },
    async goCart() {
  ...
  watch: {
    ...
    spuSaleAttrList: {
      handler(newValue) {
        this.$nextTick(() => {
          const test = this.spuSaleAttrList.length;
